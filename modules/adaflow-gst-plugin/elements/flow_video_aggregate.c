...
GST_ELEMENT_REGISTER_DEFINE (flow_video_aggregate, "flow_video_aggregate",
    GST_RANK_NONE, GST_TYPE_FLOWAGGREGATOR);
 ...
 */
static void
gst_flowaggregator_set_property (GObject * object, guint prop_id,
 ...
 */
static void
gst_flowaggregator_get_property (GObject * object, guint prop_id,
 ...
 */
static gboolean
gst_flowaggregator_sink_event (GstPad * pad, GstObject * parent,
    GstEvent * event)
{
...
gst_flowaggregator_chain (GstPad * pad, GstObject * parent, GstBuffer * buf)
{
 ...
 */
static void
gst_flowaggregator_finalize (GObject * object)
{
...
static void
gst_flowaggregator_init_after_props (GstFlowaggregator * filter)
{
  //pass
}

static GstPad *
gst_flowaggregator_request_new_pad (GstElement * element,
 ...
 */
static void
gst_flowaggregator_class_init (GstFlowaggregatorClass * klass)
{
  ...
  gst_element_class_set_details_simple (element_class, "flow_video_aggregate",
      "AdaFlow", "flow_video_aggregate", "AUTHOR_NAME AUTHOR_EMAIL");
 ...
 */
static void
gst_flowaggregator_init (GstFlowaggregator * self)
{
  /** init properties */
